...
import { FaArrowLeft, FaCircle, FaHistory } from 'react-icons/fa'
  ...
  return (
    <>
      ...
      <div className="md:hidden sticky top-0 bg-white z-50 relative">
        ...
        <h3 className="font-bold border-b text-center py-2 mx-20">My Events</h3>
      </div>
          ...
          <div>
            <div className="grid grid-cols-5 my-3">
              ...
              <div className="col-span-3 pl-3 pt-1">
                <p className="text-lg truncate">Event Heading</p>
                ...
                <div>
                  ...
                  <div className="text-center mt-5">
                    <h1 className="font-bold">
                      {host ? 'Events Hosted' : 'Events Joined'}
                    </h1>
                  </div>
                  <div className="text-center">
                    <button className="btn rounded btn-ghost no-animation text-xs">
                      ...
                      <label className="swap">
                        ...
                        />
                        <div className="swap-on">&nbsp;Events Joined</div>
                        <div className="swap-off">&nbsp;Hosted Events</div>
                      </label>
                    </button>
                  </div>
                </div>
